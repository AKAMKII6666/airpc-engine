...
import {
	...
	memoryToolTraceRefs,
} from "../../src/runtime/memory/memoryCommitContext.js";

function sessionResolve(): CallSession["resolve"] {
	return {
		source: "free",
...
function sessionFrozenCard(): CallSession["frozenCard"] {
	return {
		cardId: "lanxing_free",
		cardKind: "free",
...
function sessionComposeScene(): CallSession["composeScene"] {
	return {
...
function sessionRenderedPrompt(): CallSession["renderedPrompt"] {
	return {
		systemHard: [
...
function sessionFixture(): CallSession {
	return {
		...
		frozenCard: sessionFrozenCard(),
		composeScene: sessionComposeScene(),
		renderedPrompt: sessionRenderedPrompt(),
		channel: "text_turn",
