...
describe("resolvePendingStoryCard outbound selection compatibility", () => {
...
describe("resolvePendingStoryCard pinned outbound validation", () => {
	...
	it("rejects an exact instance that is not eligible for outbound", () => {
		const profile = profileWithPending([
			{
				instanceId: "inbound-only",
				cardId: "lanxing_wrong_number",
				chapterId: "wrong_number_act1",
				agentId: "lanxing",
				status: "pending",
