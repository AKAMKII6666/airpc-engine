...
function card(
	partial: Partial<CallCardDefinition> & {
		cardId: string;
		ownerAgentId: string;
		cardKind: CallCardDefinition["cardKind"];
	},
): CallCardDefinition {
	return {
...
function scheduleLookup(chapterId: string, cardId: string) {
	if (chapterId === SCHEDULE_CHAPTER_ID && cardId === "morning") return schedule;
	if (chapterId === SCHEDULE_CHAPTER_ID && cardId === "morning_b") {
		return otherOwner;
	}
...
describe("resolveScheduledCardReference not found", () => {
...
describe("resolveScheduledCardReference owner", () => {
...
describe("resolveScheduledCardReference story forbidden", () => {
...
describe("resolveScheduledCardReference ok", () => {
...
describe("resolveScheduledCardReference fallback kind", () => {
