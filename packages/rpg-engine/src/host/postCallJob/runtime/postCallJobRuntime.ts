...
import type { VoicemailMaterializeHostPorts } from "../../voicemail/materializeVoicemailsAfterPlan.js";
import { buildPostCallJobRuntimeCore } from "./postCallJobRuntimeHelpers.js";
...
export function createPostCallJobRuntime(deps: PostCallJobRuntimeDeps) {
	const core = buildPostCallJobRuntimeCore(deps);
	return {
		...core,
		postCallJobSummary,
