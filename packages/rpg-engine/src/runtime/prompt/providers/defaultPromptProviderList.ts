/**
 * 内置 Prompt Provider 列表本体；从 defaultPromptProviders 拆出以降文件行数。
 */
...
} from "../blocks/personalityPrompt.js";
import type { PromptProvider, PromptProviderContext } from "../compose/composer.js";
import {
	...
	createOpeningPolicy,
} from "../blocks/promptPhoneBlocks.js";
import { resolveOpeningSituation } from "../../opening/openingSituationResolver.js";
import { openingForSituation } from "../../opening/openingSituationOpenings.js";
...
function layerMatches(layer: PromptSceneLayer, scene: ComposeScene): boolean {
	const m = layer.match;
	if (
		m.callDirection &&
