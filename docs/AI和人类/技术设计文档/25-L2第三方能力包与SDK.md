...
**前置：** [24](./24-L1第一方能力包与流水线插槽.md) 插槽形状稳定；`apiVersion=1` 已冻结。  
**执行索引：** [L2 分期执行索引](../里程碑/v2.0/L2第三方能力包_分期执行索引.md)。  
**作者手册（第三方怎么写包）：** [L2 特性插件作者手册](../里程碑/v2.0/L2特性插件作者手册.md)。
...
| [《特性插件作者手册》](../里程碑/v2.0/L2特性插件作者手册.md) | 最小可跑包、清单、槽点贡献形状、API 诚实口径、UI、挂机→外呼、调试检查清单 |
