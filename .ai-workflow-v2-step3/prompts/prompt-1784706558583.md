...
Block origin status: BLOCK_ANALYZE
Block reason: hard_stop matched 留下 @deprecated 已迁至|兼容转发壳|无引用 mock 文件不删: 无引用 mock 文件不删
...
{
  "schemaVersion": 1,
  "analysisRunId": "block-analysis-1784706558583-752621e7",
  "role": "block-analyzer",
