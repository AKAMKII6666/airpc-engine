...
function useCanvasWriteBindings(
	...
	return { onApplyNodeData, onApplyChapterNodeData, onAssignOwner };
}
...
export function useStoryEditorCanvasBindings(
	...
	const writes = useCanvasWriteBindings(canvasApiRef, flush);
	...
	return {
		...
		onCanvasReady,
		onGraphMetaChange,
		onApplyNodeData: writes.onApplyNodeData,
		onApplyChapterNodeData: writes.onApplyChapterNodeData,
		onAssignOwner: writes.onAssignOwner,
	};
}
