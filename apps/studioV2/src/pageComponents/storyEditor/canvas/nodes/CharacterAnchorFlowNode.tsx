/**
	...
	* 编辑落盘复用 /characters FormModal；不写 storis-packages。
	*/
"use client";
...
export const CharacterAnchorFlowNode: FC<NodeProps> = function CharacterAnchorFlowNode({
	...
	const rootClass = selected
		? `${styles.characterAnchor} ${styles.characterAnchorSelected}`
	...
	return (
		<div className={rootClass} title={`${data.statusLabel} · 点选编辑`}>
			...
			<div className={styles.anchorBody}>
				...
				<div className={styles.anchorMeta}>挂卡 {data.pendingCardCount}</div>
			</div>
