...
import { ExitEffectPanel } from "@studio-v2/src/pageComponents/storyEditor/com/panel/ExitListEditor/com/effects/shared/ExitEffectPanel";
import styles from "../../index.module.scss";

function ExitEffectNameField({
	// effect 是当前效果枚举，用于下拉回显
	effect,
	...
	return (
		...
		<TextField
			...
			value={coerceKnownEffectName(effect)}
			onChange={(e) => {
	...
	return (
		<li className={styles.effectRow}>
			<div className={styles.effectRowHead}>
				{/* 引用了ExitEffectNameField组件，用于 effect 枚举下拉 */}
				<ExitEffectNameField
					effect={fx.effect}
