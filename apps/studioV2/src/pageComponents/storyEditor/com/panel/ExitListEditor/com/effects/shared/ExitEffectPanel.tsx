...
import { KeepCardPendingEffectPanel } from "@studio-v2/src/pageComponents/storyEditor/com/panel/ExitListEditor/com/effects/pending/KeepCardPendingEffectPanel";
// 引用了PendingEffectPanel组件，用于未落地 effect 的占位
import { PendingEffectPanel } from "@studio-v2/src/pageComponents/storyEditor/com/panel/ExitListEditor/com/effects/pending/PendingEffectPanel";
// 引用了ScheduleCallCardEffectPanel组件，用于 schedule_call_card 面板
import { ScheduleCallCardEffectPanel } from "@studio-v2/src/pageComponents/storyEditor/com/panel/ExitListEditor/com/effects/schedule/panels/ScheduleCallCardEffectPanel";
// 引用了CreateResearchCommitmentEffectPanel组件，用于 create_research_commitment 面板
import { CreateResearchCommitmentEffectPanel } from "@studio-v2/src/pageComponents/storyEditor/com/panel/ExitListEditor/com/effects/system/CreateResearchCommitmentEffectPanel";
// 引用了UpdateUserProfileEffectPanel组件，用于 update_user_profile 面板
import { UpdateUserProfileEffectPanel } from "@studio-v2/src/pageComponents/storyEditor/com/panel/ExitListEditor/com/effects/worldProfile/UpdateUserProfileEffectPanel";
// 引用了SetWorldFactEffectPanel组件，用于 set_world_fact 面板
import { SetWorldFactEffectPanel } from "@studio-v2/src/pageComponents/storyEditor/com/panel/ExitListEditor/com/effects/worldProfile/SetWorldFactEffectPanel";
// 引用了PlaySystemPromptEffectPanel组件，用于 play_system_prompt 面板
import { PlaySystemPromptEffectPanel } from "@studio-v2/src/pageComponents/storyEditor/com/panel/ExitListEditor/com/effects/system/PlaySystemPromptEffectPanel";
// 引用了ScheduleRecurringCallEffectPanel组件，用于 schedule_recurring_call 面板
import { ScheduleRecurringCallEffectPanel } from "@studio-v2/src/pageComponents/storyEditor/com/panel/ExitListEditor/com/effects/schedule/panels/ScheduleRecurringCallEffectPanel";
// 引用了EndStoryEffectPanel组件，用于 end_story 复合面板
import { EndStoryEffectPanel } from "@studio-v2/src/pageComponents/storyEditor/com/panel/ExitListEditor/com/effects/endStory/EndStoryEffectPanel";
// 引用了SetCharacterUnlockedEffectPanel组件，用于 set_character_unlocked 面板
import { SetCharacterUnlockedEffectPanel } from "@studio-v2/src/pageComponents/storyEditor/com/panel/ExitListEditor/com/effects/character/SetCharacterUnlockedEffectPanel";
// 引用了SetRedialSlotEffectPanel组件，用于 set_redial_slot 面板
import { SetRedialSlotEffectPanel } from "@studio-v2/src/pageComponents/storyEditor/com/panel/ExitListEditor/com/effects/character/SetRedialSlotEffectPanel";
// 引用了PatchMemoryEffectPanel组件，用于 patch_memory 面板
import { PatchMemoryEffectPanel } from "@studio-v2/src/pageComponents/storyEditor/com/panel/ExitListEditor/com/effects/patchMemory/PatchMemoryEffectPanel";
// 引用了UpdateNpcKnowledgeEffectPanel组件，用于 update_npc_knowledge 面板
import { UpdateNpcKnowledgeEffectPanel } from "@studio-v2/src/pageComponents/storyEditor/com/panel/ExitListEditor/com/effects/worldProfile/UpdateNpcKnowledgeEffectPanel";
