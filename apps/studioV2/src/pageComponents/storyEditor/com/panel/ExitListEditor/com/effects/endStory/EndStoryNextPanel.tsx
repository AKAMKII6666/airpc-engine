...
import { EndStoryNextTargetPanel } from "@studio-v2/src/pageComponents/storyEditor/com/panel/ExitListEditor/com/effects/endStory/EndStoryNextTargetPanel";
// 引用了EndStoryNextActivationPanel组件，用于激活方式字段
import { EndStoryNextActivationPanel } from "@studio-v2/src/pageComponents/storyEditor/com/panel/ExitListEditor/com/effects/endStory/EndStoryNextActivationPanel";
