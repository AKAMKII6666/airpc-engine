...
import { ChapterEndNextFields } from "@studio-v2/src/pageComponents/storyEditor/com/panel/chapter/ChapterEndNextFields";
import styles from "../nodeProperty/NodePropertyForm.module.scss";
...
function ChapterIdentityFields({
	// formik 是章节属性 Formik，用于标题与摘要绑定
	formik,
}: {
	formik: FormikProps<ChapterPropertyFormValues>;
}) {
	...
	function ChapterPropertyForm({
		...
		return (
			...
			>
				...
				{/* 引用了ChapterIdentityFields组件，用于章节标题与摘要 */}
				<ChapterIdentityFields formik={formik} />
				{isEnd ? (
