...
import { CharacterDetailSaveActions } from "@studio-v2/src/pageComponents/characters/com/detail/CharacterDetailSaveActions";
...
function renderCharacterDetailTail(
	character: CharacterSummary,
	formik: FormikProps<CharacterDetailFormValues>,
	freeCardOpen: boolean,
	setFreeCardOpen: Dispatch<SetStateAction<boolean>>,
) {
	return (
		<>
	...
	function CharacterDetailEditForm({
		...
		return (
			<form onSubmit={formik.handleSubmit} noValidate>
				...
				{renderCharacterDetailTail(character, formik, freeCardOpen, setFreeCardOpen)}
			</form>
		);
	};
