...
import { DebugScenePanel } from "@studio-v2/src/pageComponents/debugger/com/callRun/DebugScenePanel";
// 引用了CallRunPanel组件，用于中部通话运行叙事
import { CallRunPanel } from "@studio-v2/src/pageComponents/debugger/com/callRun/CallRunPanel";
// 引用了RoleBoardPanel组件，用于右侧角色挂卡状态
import { RoleBoardPanel } from "@studio-v2/src/pageComponents/debugger/com/callRun/RoleBoardPanel";
